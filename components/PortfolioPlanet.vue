<template>
    <div class="portfolio-planet">
        ...
        <div class="portfolio-planet__head-wrapper portfolio-planet__head-wrapper--planet">
            ...
            <!-- <a target="_blank" :href="gitLink"><button class="portfolio-planet__view-btn btn--blue" >Visit site</button></a> -->
        </div>
        ...
        <div class="portfolio-planet__wrapper">
            ...
            <a target="_blank" :href="gitLink"><button class="portfolio-planet__btn btn--blue btn--rounded">See more</button></a>
        </div>
